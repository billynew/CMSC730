...
| Mon Sep 18 <br> [ Smartphone Interaction](){: .btn .btn-blue } <br>[R1](){: .label .label-green }[R2](){: .label .label-green }             | Wed Sep 20 <br> [Electronics - Digital IO](){: .btn .btn-purple }  <br>[Instruction](){: .label .label-purple } |
| Mon Sep 25 <br> [Wearables](){: .btn .btn-blue} <br> [R1](){: .label .label-green }[R2](){: .label .label-green }            | Wed Sep 27 <br> [Electronics: Analog and Sensing](){: .btn .btn-purple} <br> [A3](){: .label .label-purple }|
