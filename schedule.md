...
| Mon Oct 3 <br> [ Tangible Interaction](https://smartlab.cs.umd.edu/CMSC730/assets/pdf/lectures/10-Tangible%20Interaction.pdf){: .btn .btn-blue }   <br>[R1](){: .label .label-green }[R2](){: .label .label-green }           | Wed Oct 5 <br> [Electronics - Servo + Ultrasonic Sensors](){: .btn .btn-purple} <br> [A](){: .label .label-purple }|
| Mon Oct 10 <br> [ Display](){: .btn .btn-blue }    <br>[R1](){: .label .label-green }[R2](){: .label .label-green }          | Wed Oct 12 <br> [Electronics: IMU 1 and I2C2](){: .btn .btn-purple} <br> [A](){: .label .label-purple }|
