...
| Mon Nov 27 <br> [Fabrication 2 - Additive Manufacturing](){: .btn .btn-blue }   <br>[R1](){: .label .label-green }[R2](){: .label .label-green }           | Wed Nov 29 <br> [OLED Display](){: .btn .btn-purple} <br> [A10](assets/pdf/assignments/Assignment_Fall23_A10.pdf){: .label .label-purple }|
