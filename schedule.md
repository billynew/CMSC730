...
| Mon Sep 26 <br> [Electronics - Digital IO](){: .btn .btn-purple }  <br>[A](){: .label .label-purple }            | Wed Sep 28 <br> [Electronics: Analog and Sensing](){: .btn .btn-purple} <br> [A](){: .label .label-purple }|
